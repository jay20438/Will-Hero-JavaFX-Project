...
//
//public class blankControllerNg implements Initializable {
...
//                createEntity = new CreateEntityNg( this, island1, mainAnchorPane);
//                createEntity.create();
//                createEntity = new CreateEntityNg(this, island2, mainAnchorPane);
//                createEntity.create();
//                createEntity = new CreateEntityNg(this, island3, mainAnchorPane);
//                createEntity.create();
//            }
//
//            if ((int) (island6.getBoundsInParent().getMaxX()) < 0) {
//                createIsland(4, island4, island5, island6);
//                createEntity = new CreateEntityNg(this, island4, mainAnchorPane);
//                createEntity.create();
//                createEntity = new CreateEntityNg(this, island5, mainAnchorPane);
//                createEntity.create();
//                createEntity = new CreateEntityNg(this, island6, mainAnchorPane);
//                createEntity.create();
//            }
//        }
//    }
