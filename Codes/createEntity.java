...
//        double islandBaseY = gpOperatingOn.getBoundsInParent().getMinY() + bk.getDepthOfBaseOfIsland(gpOperatingOn);
        double depthOfBaseOfIslands =bk.getDepthOfBaseOfIsland(gpOperatingOn);
        ...
        if(randNoLevel1 == 0){
            ...
            if(entities[randNoLevel2].equals("closedChest")){
                new ChestType("closedChest", gpOperatingOn, random.nextInt((int)gpOperatingOn.getBoundsInParent().getMinX(), (int)gpOperatingOn.getBoundsInParent().getMaxX()-20), depthOfBaseOfIslands - heightOfEntity, heightOfEntities.get("closedChest"), widthOfEntities.get("closedChest"));
            }else{
                randNoLevel3 = random.nextInt(3) + 1;
                ...
                for (int i = 0; i < randNoLevel3; i++) {
                    help4Sum += dist[i];
                    if (entities[randNoLevel2].equals("greenOrc")){
                        new GreenOrc("greenOrc", gpOperatingOn, help4Sum + i*widthOfEntities.get(entities[randNoLevel2]), depthOfBaseOfIslands - heightOfEntity, heightOfEntities.get("greenOrc"), widthOfEntities.get("greenOrc"));
                    }else if(entities[randNoLevel2].equals("redOrc")){
                        new RedOrc("redOrc", gpOperatingOn, help4Sum + i*widthOfEntities.get(entities[randNoLevel2]), depthOfBaseOfIslands - heightOfEntity, heightOfEntities.get("redOrc"), widthOfEntities.get("redOrc"));
                    }else if(entities[randNoLevel2].equals("coin")){
                        new Coin("coin", gpOperatingOn, help4Sum + i*widthOfEntities.get(entities[randNoLevel2]), depthOfBaseOfIslands - heightOfEntity, heightOfEntities.get("coin"), widthOfEntities.get("coin"));
                    }else if(entities[randNoLevel2].equals("coin")){
                        new TNT("coin", gpOperatingOn, help4Sum + i*widthOfEntities.get(entities[randNoLevel2]), depthOfBaseOfIslands - heightOfEntity, heightOfEntities.get("tnt"), widthOfEntities.get("tnt"));
                    }
                }
            }
        }
